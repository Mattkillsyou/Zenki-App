...
export const PRODUCTS: Product[] = [
  ...
  {
    id: '2',
    name: 'In Zenki Dojo We Trust Hoodie',
    category: 'Apparel',
    price: 100.00,
    memberPrice: 85.00,
    ...
    badge: null,
    description: 'Heavyweight fleece hoodie with embroidered "In Zenki Dojo We Trust" crest. 80% cotton, 20% polyester. Kangaroo pocket, ribbed cuffs.',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    inStock: true,
  },
  {
  ...
  {
    id: '8',
    name: 'Zenki Dojo Samurai Handwraps',
    category: 'Gear',
    price: 20.00,
    memberPrice: 17.00,
  ...
  },
  {
    ...
    badge: null,
    description: 'Insulated water bottle holder with Zenki Dojo branding. Adjustable strap, fits most bottles up to 32oz.',
    inStock: true,
  },
];
