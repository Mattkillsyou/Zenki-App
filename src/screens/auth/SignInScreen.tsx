...
const styles = StyleSheet.create({
  ...
  tagline: { fontSize: 13, fontWeight: '600', letterSpacing: 3, marginTop: 2 },

  // Form
  formSection: { gap: 10 },
  welcomeBlock: { alignItems: 'center', gap: 2 },
  heading: { fontSize: 40, fontWeight: '800', letterSpacing: -1, lineHeight: 44, textAlign: 'center' },
  subheading: { fontSize: 18, fontWeight: '400', lineHeight: 22, textAlign: 'center' },
