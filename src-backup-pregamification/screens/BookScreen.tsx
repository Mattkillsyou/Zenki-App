  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top']}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity
            style={[
              ...
              { backgroundColor: calendarLinked ? colors.goldMuted : colors.surface },
              calendarLinked && { borderColor: colors.gold, borderWidth: 1 },
            ]}
        ...
        <View style={styles.section}>
          ...
          {INSTRUCTORS.map((inst, index) => {
            ...
            return (
              ...
              >
                <View style={[styles.instructorAvatar, { backgroundColor: isSelected ? colors.gold : colors.surfaceSecondary }]}>
                  <Text style={[styles.avatarText, { color: isSelected ? colors.textInverse : colors.textMuted }]}>
                    {inst.avatar}
                  </Text>
                </View>
                <View style={styles.instructorInfo}>
                  <Text style={[styles.instructorName, { color: colors.textPrimary }]}>
                    {inst.name}
                  </Text>
            ...
            {SESSION_TYPES.map((type, index) => {
              ...
              return (
                ...
                >
                  ...
                  <Text style={[styles.typeDuration, { color: colors.textMuted }]}>
                    {type.duration}
                  </Text>
                  <Text style={[
                    styles.typePrice,
        ...
        {/* Summary & Book */}
        {selectedTime && (
          <View style={[styles.summaryCard, { backgroundColor: colors.surface, marginHorizontal: spacing.lg }]}>
