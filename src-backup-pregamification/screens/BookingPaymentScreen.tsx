    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top']}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <Text style={[styles.title, { color: colors.textPrimary }]}>Payment</Text>
        ...
        <View style={[styles.summaryCard, { backgroundColor: colors.surface }]}>
          ...
          <View style={styles.summaryRow}>
            ...
            <Text style={[styles.summaryValue, { color: colors.gold, fontWeight: '900', fontSize: 22 }]}>
              ${price}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity
            style={[
              ...
              paymentMethod === 'apple' && { borderColor: colors.gold },
            ]}
          ...
          <TouchableOpacity
            style={[
              styles.methodCard,
              { backgroundColor: colors.surface },
              paymentMethod === 'card' && { borderColor: colors.gold },
            ]}
