...
YOUR EXCLUSIVE FILES: scripts/build-senpai-flipbooks.sh, src/components/SenpaiFlipbook.tsx, src/components/senpaiMoodAssets.ts, src/assets/senpai/** and SenpaiMascot.tsx ONLY if the cache-version constant lives there. Implement Phase B per SENPAI_ENHANCEMENT_PLAN.md sec 1.3:
